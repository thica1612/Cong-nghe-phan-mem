...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CertificationId).HasName("PK__Certific__1237E5AA25CBBA71");
        ...
        {
            entity.HasKey(e => e.CertificationKsid).HasName("PK__Certific__5192CFD675ED183D");
        ...
        {
            entity.HasKey(e => e.ConsignmentId).HasName("PK__Consignm__2AB75863E62A8461");
        ...
        {
            entity.HasKey(e => e.ReportId).HasName("PK__Dashboar__D5BD48E5E83B84B2");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF609219F9B");
        ...
        {
            entity.HasKey(e => e.KoiId).HasName("PK__Koi__915924EF1013BDEA");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__KoiOrder__C3905BAF9A2D5718");
        ...
        {
            entity.HasKey(e => e.KoiSaleId).HasName("PK__KoiSale__D586FFEB18CF8E41");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__KoiUser__CB9A1CDFF206A87F");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C85A31C7C");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__52C42F2F920CE243");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4B79FD0623");
